    ...
    return ClipRect(
      child: AnimatedBuilder(
        ...
        builder: (_, child) => Align(
          ...
          child: opacityWidget(child: child),
        ),
        child: opacityWidget(child: widget.child),
      ),
    );
  }

  Widget opacityWidget({required Widget? child}) => AnimatedOpacity(
        opacity: widget.withOpacity ? (widget.open ? 1 : 0) : 1,
